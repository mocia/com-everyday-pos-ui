...
export class View {
    ...
    generatePrintStrukTable() { 
        ...
        // this.printStruk += "    </tr>";
        this.printStruk += "    <tr>";
        this.printStruk += "        <td colspan='3' class='text-left'> PT. BATEEQ RETAILINDO UTAMA </td>";
        this.printStruk += "    </tr>";
        this.printStruk += "    <tr>";
        this.printStruk += "        <td colspan='3' class='text-left'> Jln Merapi No. 23 RT. 000 RW. 000 Banaran, Grogol Kab. Sukoharjo Jawa Tengah </td>";
        this.printStruk += "    </tr>";
        this.printStruk += "    <tr>";
