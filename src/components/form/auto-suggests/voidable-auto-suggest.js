...
import VoidableAutoSuggestReact from '../../react/auto-suggests/voidable-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('voidable-auto-suggest')
export class VoidableAutoSuggest {
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <VoidableAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
