...
const serviceUri = require('../../../host').store;
const empty = {
    code: '',
    name: '',
    toString: function () {
...
export default class VoidableAutoSuggestReact extends React.Component {
    constructor(props) {
        super(props);
...
VoidableAutoSuggestReact.defaultProps = {
    options: {
        ...
        function (text) {
            ...
            var uri = serviceUri + "/" + session.store._id + "/sales/docs/salesvoids/voidables?keyword=" + text;            
