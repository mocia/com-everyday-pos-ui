...
export default class ReturnableAutoSuggestReact extends React.Component {
    constructor(props) {
        super(props);
...
ReturnableAutoSuggestReact.defaultProps = {
    options: {
        ...
        function (text) {
            ...
            var uri = serviceUri + "/" + session.store._id + "/sales/docs/salesreturns/returnables?keyword=" + text;
